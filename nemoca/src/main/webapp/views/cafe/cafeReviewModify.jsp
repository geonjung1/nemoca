...
<body>
	<form name="inputForm" method="post" action="cafeDoReviewModify.yo">
		...
		<div class="reviewTable2">
			<table border="0">
				<tr>
					<td><textarea name="cr_content" required placeholder="(회원 닉네임) 주문하신 메뉴는 어떠셨나요? 카페 분위기와 서비스도 궁금해요!">${cafeReview.cr_content}</textarea></td>
				</tr>
				<tr>
					<td	height="30px">
						<span class="cafeStar">
		...
		<div class="buttonTable">
			<table border="0">
				...
				<tr>
					<td></td>
					<td>
						<input type="text" name="cr_no" value="${cafeReview.cr_no}" style="display:none;">
						<input type="text" name="c_no" value="${cafeReview.c_no}" style="display:none;">
